...
class KC(App):
    ...
    def on_button_press(self, instance):
        ...
        if button_text =='C':
            ...
            if current and (
                self.last_was_operator and button_text in self.opreators):
                return
            elif current == "" and button_text in self.opreators:
                return
            else:
                new_text = current + button_text
                self.solution.text = new_text
        self.last_buton = button_text
        self.last_was_operator = self.last_buton in self.opreators
